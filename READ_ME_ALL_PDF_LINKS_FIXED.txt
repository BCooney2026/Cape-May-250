...
Verification:
{
  ...
  "patch_counts": {
    "pdfs/daily_plans/05_Saturday_America_250_Main_Event.pdf": 1,
    "pdfs/daily_plans/07_Monday_Last_Full_Day.pdf": 1
  },
  "verify_problem_files": {
    "pdfs/daily_plans/04_Friday_Arrival_250_Warmup.pdf": {
      "exists": true,
      "links_after_patch": [
        {
          "page": 1,
    ...
    "pdfs/daily_plans/05_Saturday_America_250_Main_Event.pdf": {
      "exists": true,
      "links_after_patch": [
        {
          "page": 1,
    ...
    "pdfs/daily_plans/07_Monday_Last_Full_Day.pdf": {
      "exists": true,
      "links_after_patch": [
        {
          "page": 1,
